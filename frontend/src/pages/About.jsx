    ...
    <div>
      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row mb-20">
          <div className="border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] text-gray-600 duration-300 transition-all hover:text-white hover:bg-blue-600 cursor-pointer">
            <b>Efficiency:</b>
